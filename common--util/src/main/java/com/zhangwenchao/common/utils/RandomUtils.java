...
public class RandomUtils {
	...
	/**
	 * 
	 * @Title: getRandomChar @Description: TODO 获取随机数 @param @return 参数 @return char
	 *         返回类型 @throws
	 */
	...
	public static char getRandomChar() {
		...
		int starChar = 'a' + 0;
		// 生成随机数
		char newCahr = (char) (starChar + random.nextInt(26));
		return newCahr;
	...
	/**
	 * 
	 * @Title: getRandomNumber @Description: TODO 获取随机的数字 @param 参数 @return char
	 *         返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: getRandomNUmandChar @Description: TODO( 获取随机数) @param @param
	 *         num @param @return 参数 @return String 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: random @Description: 获取最大数he最小数之间的随机数 @param @param min @param @param
	 *         max @param @return 参数 @return int 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: random @Description: 获取最小数和最大数之间的多个随机数 @param @param
	 *         min @param @param max @param @param nunm @param @return 参数 @return
	 *         int[] 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: randomChineseString @Description: 返回一个中文文字 @return String
	 * 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: RandomChineseString @Description:
	 * 返回参数length个中文汉字字符串，字符集必须在GB2312(相当于中文简体)范围内 @param @param
	 * lenth @param @return 参数 @return String 返回类型 @throws
	 */

	public static String randomChineseString(int lenth) {
	...
	/**
	 * 
	 * @Title: randomChineseName @Description: 返回中文姓名 @param @return 参数 @return
	 * String 返回类型 @throws
	 */
	public static String randomChineseName() {
		...
		// 随机获取姓shi
		String name1 = surname[RandomUtils.random(0, surname.length - 1)];
		// 随机获取1-2个中文
